# CS254-Final
Final for CS254 Machine Learning by Gabriela Salazar Lopez, Chongqing Gao, Lichao Yang, and Isabelle Francke
...
inital_model_data_preprocessing.py: preprocessing/cleaning of data for training initial model 
